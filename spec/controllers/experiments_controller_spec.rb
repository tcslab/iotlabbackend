  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved experiment as @experiment" do
        post :create, {:experiment => invalid_attributes}, valid_session
        expect(assigns(:experiment)).to be_a_new(Experiment)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested experiment" do
        experiment = Experiment.create! valid_attributes
        put :update, {:id => experiment.to_param, :experiment => new_attributes}, valid_session
        experiment.reload
    ...
    context "with invalid params" do
      it "assigns the experiment as @experiment" do
        experiment = Experiment.create! valid_attributes
        put :update, {:id => experiment.to_param, :experiment => invalid_attributes}, valid_session
        expect(assigns(:experiment)).to eq(experiment)
      end
